...
$(document).ready(function () {
  ...
  function translate_input_text() {
    var trimmed_input = $.trim($('#input').val());
    if (trimmed_input) {
  ...
  function set_recognized_language(language) {
    var trimmed_language = $.trim(language);
  ...
  function set_translator(translator) {
    var trimmed_translator = $.trim(translator);
    if ($.inArray(trimmed_translator, ['Google', 'Yandex']) !== -1) {
      var new_value = trimmed_translator === 'Google' ? 'google_translate' : 'yandex_translate';
  ...
  function dictate_translation(text, selected_language, api) {
    $.ajax({
      ...
      dataType: 'json',
      success: function success(data) {
        var destinationLanguage = $('#translation-language').val();
        ...
        if ($.trim(data.translated_text).length) {
          ...
          var voice_language = 'Spanish Female';
  ...
  function recognize_with_annyang() {
    if (annyang) {
      ...
      annyang.addCallback('resultNoMatch', function (phrases) {
        ...
        var trimmed_output = $.trim(output);
...
!function (a, b) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return a.annyang = b(a);
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = b(a) : a.annyang = b(a);
...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice);else var ResponsiveVoice = function ResponsiveVoice() {
  var a = this;a.version = "1.5.0";console.log("ResponsiveVoice r" + a.version);a.responsivevoices = [{ name: "UK English Female", flag: "gb", gender: "f", voiceIDs: [3, 5, 1, 6, 7, 171, 201, 8] }, { name: "UK English Male", flag: "gb", gender: "m", voiceIDs: [0, 4, 2, 75, 202, 159, 6, 7] }, { name: "US English Female", flag: "us", gender: "f", voiceIDs: [39, 40, 41, 42, 43, 173, 205, 204, 235, 44] }, { name: "Arabic Male",
    ...
    voiceIDs: [192, 193, 232, 250, 251, 252] }, { name: "Chinese Taiwan Female", flag: "tw", gender: "f", voiceIDs: [252, 194, 233, 253, 254, 255] }, { name: "Czech Female", flag: "cz", gender: "f", voiceIDs: [101, 100, 102, 197, 103] }, { name: "Danish Female", flag: "dk", gender: "f", voiceIDs: [105, 104, 106, 198, 107] }, { name: "Deutsch Female", flag: "de", gender: "f", voiceIDs: [27, 28, 29, 30, 31, 78, 170, 199, 32] }, { name: "Dutch Female", flag: "nl", gender: "f", voiceIDs: [243, 219, 84, 157, 158, 184, 45] }, { name: "Finnish Female", flag: "fi", gender: "f", voiceIDs: [90, 89, 91, 209, 92] }, { name: "French Female", flag: "fr", gender: "f", voiceIDs: [240, 21, 22, 23, 77, 178, 210, 26] }, { name: "Greek Female", flag: "gr", gender: "f", voiceIDs: [62, 63, 80, 200, 64] }, { name: "Hatian Creole Female", flag: "ht", gender: "f", voiceIDs: [109] }, { name: "Hindi Female", flag: "hi", gender: "f", voiceIDs: [247, 66, 154, 179, 213, 67] }, { name: "Hungarian Female", flag: "hu", gender: "f", voiceIDs: [9, 10, 81, 214, 11] }, { name: "Indonesian Female", flag: "id", gender: "f", voiceIDs: [241, 111, 112, 180, 215, 113] }, { name: "Italian Female", flag: "it", gender: "f", voiceIDs: [242, 33, 34, 35, 36, 37, 79, 181, 216, 38] }, { name: "Japanese Female", flag: "jp", gender: "f", voiceIDs: [248, 50, 51, 52, 153, 182, 217, 53] }, { name: "Korean Female", flag: "kr", gender: "f", voiceIDs: [54, 55, 56, 156, 183, 218, 57] }, { name: "Latin Female", flag: "va", gender: "f", voiceIDs: [114] }, { name: "Norwegian Female", flag: "no", gender: "f", voiceIDs: [72, 73, 221, 74] }, { name: "Polish Female", flag: "pl", gender: "f", voiceIDs: [244, 120, 119, 121, 185, 222, 122] }, { name: "Portuguese Female", flag: "br", gender: "f", voiceIDs: [128, 127, 129, 187, 224, 130] }, { name: "Romanian Male",
  ...
  a.is_safari = -1 < navigator.userAgent.indexOf("Safari");a.is_chrome && a.is_safari && (a.is_safari = !1);a.is_opera = !!window.opera || 0 <= navigator.userAgent.indexOf(" OPR/");a.is_android = -1 < navigator.userAgent.toLowerCase().indexOf("android");a.iOS_initialized = !1;a.iOS9_initialized = !1;a.cache_ios_voices = [{ name: "he-IL", voiceURI: "he-IL", lang: "he-IL" }, { name: "th-TH", voiceURI: "th-TH", lang: "th-TH" }, { name: "pt-BR", voiceURI: "pt-BR", lang: "pt-BR" }, { name: "sk-SK", voiceURI: "sk-SK", lang: "sk-SK" }, { name: "fr-CA", voiceURI: "fr-CA",
  ...
  };a.fallbackServicePath = "https://code.responsivevoice.org/" + (a.tstCompiled() ? "" : "develop/") + "getvoice.php";a.default_rv = a.responsivevoices[0];a.debug = !1;a.log = function (b) {
    ...
    a.fallbackMode = !0;console.log("RV: Enabling fallback mode");
    a.mapRVs();null != a.OnVoiceReady && a.OnVoiceReady.call();a.Dispatch("OnReady");window.hasOwnProperty("dispatchEvent") && window.dispatchEvent(new Event("ResponsiveVoice_OnReady"));
    ...
    if (a.iOS9 && !a.iOS9_initialized) a.log("Initializing ios9"), setTimeout(function () {
      ...
      a.isPlaying() && (a.log("Cancelling previous speech"), a.cancel());a.fallbackMode && 0 < a.fallback_audiopool.length && a.clearFallbackPool();b = b.replace(/[\"\`]/gm, "'");a.msgparameters = e || {};a.msgtext = b;a.msgvoicename = c;a.onstartFired = !1;var h = [];if (b.length > a.CHARACTER_LIMIT) {
        for (var f = b; f.length > a.CHARACTER_LIMIT;) {
          var g = f.search(/[:!?.;]+/),
              d = "";if (-1 == g || g >= a.CHARACTER_LIMIT) g = f.search(/[,]+/);-1 == g && -1 == f.search(" ") && (g = 99);if (-1 == g || g >= a.CHARACTER_LIMIT) for (var k = f.split(" "), g = 0; g < k.length && !(d.length + k[g].length + 1 > a.CHARACTER_LIMIT); g++) {
            d += (0 != g ? " " : "") + k[g];
          } else d = f.substr(0, g + 1);f = f.substr(d.length, f.length - d.length);h.push(d);
        }0 < f.length && h.push(f);
      } else h.push(b);a.multipartText = h;g = null == c ? a.default_rv : a.getResponsiveVoice(c);!0 === g.deprecated && console.warn("ResponsiveVoice: Voice " + g.name + " is deprecated and will be removed in future releases");f = {};if (null != g.mappedProfile) f = g.mappedProfile;else if (f.systemvoice = a.getMatchedVoice(g), f.collectionvoice = {}, null == f.systemvoice) {
        console.log("RV: ERROR: No voice found for: " + c);return;
      }a.msgprofile = f;a.utterances = [];for (g = 0; g < h.length; g++) {
        if (a.fallbackMode) {
          a.fallback_playbackrate = a.def_fallback_playbackrate;var d = a.selectBest([f.collectionvoice.pitch, f.systemvoice.pitch, 1]),
              k = a.selectBest([a.iOS9 ? 1 : null, f.collectionvoice.rate, f.systemvoice.rate, 1]),
              l = a.selectBest([f.collectionvoice.volume, f.systemvoice.volume, 1]),
              m;null != e && (d *= null != e.pitch ? e.pitch : 1, k *= null != e.rate ? e.rate : 1, l *= null != e.volume ? e.volume : 1, m = e.extraParams || null);d /= 2;k /= 2;l *= 2;d = Math.min(Math.max(d, 0), 1);k = Math.min(Math.max(k, 0), 1);l = Math.min(Math.max(l, 0), 1);d = a.fallbackServicePath + "?t=" + encodeURIComponent(h[g]) + "&tl=" + (f.collectionvoice.lang || f.systemvoice.lang || "en-US") + "&sv=" + (f.collectionvoice.service || f.systemvoice.service || "") + "&vn=" + (f.collectionvoice.voicename || f.systemvoice.voicename || "") + "&pitch=" + d.toString() + "&rate=" + k.toString() + "&vol=" + l.toString();m && (d += "&extraParams=" + JSON.stringify(m));k = document.createElement("AUDIO");k.src = d;k.playbackRate = a.fallback_playbackrate;k.preload = "auto";k.load();a.fallback_parts.push(k);
    ...
    0 == a.fallback_part_index && a.speech_onstart();a.fallback_audio = a.fallback_parts[a.fallback_part_index];if (null == a.fallback_audio) a.log("RV: Fallback Audio is not available");else {
  ...
  a.cancel = function () {
    ...
    for (var b = 0; b < a.responsivevoices.length; b++) {
      for (var c = a.responsivevoices[b], e = 0; e < c.voiceIDs.length; e++) {
        var h = a.voicecollection[c.voiceIDs[e]];if (1 != h.fallbackvoice) {
          var f = a.getSystemVoice(h.name);if (null != f) {
            c.mappedProfile = { systemvoice: f, collectionvoice: h };break;
          }
        } else {
    ...
    for (var c = 0; c < b.voiceIDs.length; c++) {
      var e = a.getSystemVoice(a.voicecollection[b.voiceIDs[c]].name);if (null != e) return e;
    }return null;
  };a.getSystemVoice = function (b) {
    var c = String.fromCharCode(160);b = b.replace(new RegExp("\\s+|" + c, "g"), "");if ("undefined" === typeof a.systemvoices || null === a.systemvoices) return null;for (var e = 0; e < a.systemvoices.length; e++) {
    ...
    if (a.hasOwnProperty(b + "_callbacks") && null != a[b + "_callbacks"] && 0 < a[b + "_callbacks"].length) {
      for (var c = a[b + "_callbacks"], e = 0; e < c.length; e++) {
        ...
        f = b + "_callbacks_timeoutCount";a.hasOwnProperty(h) || (a[f] = 10, a[h] = setInterval(function () {
      --a[f];(a.Dispatch(b) || 0 > a[f]) && clearTimeout(a[h]);
    }, 50));return !1;
  ...
  a.tts_speak = function (b) {
    ...
    var e = a.getWords(b),
        h = 0,
        f = a.fallbackMode ? 1300 : 700;c = c || 1;e.map(function (a, b) {
      h += (a.toString().match(/[^ ]/igm) || a).length;
    });var g = e.length,
        d = 60 / a.WORDS_PER_MINUTE * c * 1E3 * g;5 > g && (d = c * (f + 50 * h));a.log("Estimated time length: " + d + " ms, words: [" + e + "], charsCount: " + h);return d;
  };
},
